export class FormValidator {
  ...
  #setEventListeners() {
    ...
    const buttonElement = this.element.querySelector(this.options.submitButtonSelector);
    this.#toggleButtonState(inputList, buttonElement, this.options.inactiveButtonClass);
